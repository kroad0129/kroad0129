#### 안녕하세요! 저는 단순한 기능 구현을 넘어, 사용자가 더 쉽게 사용할 수 있는 서비스 경험을 고민합니다. 동시에 서비스가 사용자에게는 편의를, 조직에는 실질적인 가치를 제공할 수 있도록 프로젝트 전반을 균형 있게 설계하는 것을 목표로 합니다
...
## 🎓 Experiences
- **2023.02 ~ 2026.08  |**  건국대학교(편입)
- **2024.03 ~ 2025.02  |**  스마트ICT융합공학과 학술동아리 CONA 백엔드
- **2025.03 ~ 2026.02  |**  구름톤 유니브 4기 건국대학교(서울) 부대표
- **2026.06 ~ 2026.08  |** 메타버즈 기업부설연구소 인턴
    
## 🏆 Awards
- **2025 [kakao x goorm] 딥다이브 해커톤 대상**  
  - OUTLINE | 지역 정보 격차 해소 서비스
- **2025 구름톤(교육과정) in 판교 최우수상**  
...
| 프로젝트명 | 설명 | GitHub | 자료 |
| --- | --- | --- | --- |
| 📄 **SafeLease** | 부동산 계약서 검토 서비스 | [Link](https://github.com/kroad0129/safelease) | [발표자료](https://drive.google.com/file/d/16SwzSZKo1yxeHYKdOcjoy2bZuDNXoOf3/view?usp=sharing) |
...
| --- | --- | --- | --- | --- |
| 🏸 **playcock** | 배드민턴 모임 운영 및 경기 관리 서비스 | [BE](https://github.com/kroad0129/playcock-backend) [FE](https://github.com/kroad0129/playcock-frontend) | [Demo](http://3.35.236.140/) | 진행 중 |
